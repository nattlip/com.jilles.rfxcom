...
class oregondecoding extends EventEmitter {
    ...
    constructor() {
        ...
        function processTEMPHUM(result) {
        ...
        function processTEMPHUMBAR(result) {
            util.log('  processTEMPHUMBAR(result) enterd  ');
