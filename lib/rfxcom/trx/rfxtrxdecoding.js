...
class rfxtrxdecoding extends EventEmitter {
    ...
    constructor() {
        ...
        this.receiveSerialData = (data) => {
            ...
            console.log('sequencenumer', sequencenumber)
            ...
            if (typeof handler !== "undefined" && (handler == "temphumidity19Handler" || handler == "temp19Handler"
                ...
                console.log('length data2 ', data2.length)
        ...
        this.messageHandler = (data) => {
            ...
            //}
            console.log("Response: Command message " + this.dumpHex([seqnbr]) + ", " + responses[message]);
            console.log("response", responses[message], seqnbr, message);
        };
        ...
        this.statusHandler = (data) => {
            ...
            if (subtype === 0x07) {  // Start receiver response (should return copyright message)
                ...
                //    this.acknowledge[seqnbr] = null;
                // }
                console.log("Response: Command message " + this.dumpHex([seqnbr]) + ", unknown RFY remote ID");
